...
class BrowserNotification {
  ...
  constructor(
    ...
    this.browserElement = document.querySelector('.alert') ?? document.createElement('div');
...
export default {
  [eventTypes.sent_reset_password_email]: () => {
    new CustomNotification('success', "We've sent you an email with a link to reset your password.", ['browser'], 5000).show();
  },
